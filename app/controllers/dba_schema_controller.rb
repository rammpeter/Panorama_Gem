...
WHERE RowNum < 100
  ...
  def list_dbms_metadata_get_ddl
    ...
    respond_to do |format|
      format.html {render :html => "<div class='yellow-panel'><h3>DDL for table #{@owner}.#{@table_name} generated by DBMS_METADATA.GET_DDL</h3>#{my_html_escape(ddl)}</div>".html_safe }
    end
